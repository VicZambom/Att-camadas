...
class RepositorioUsuario:
    ...
    def salvar(self, usuario: Usuario) -> Usuario:
        ...
        try:
            ...
            cursor.execute(
                """
                INSERT INTO usuarios (nome, telefone, email, ativo)
                VALUES (?, ?, ?, ?)
                """,
                (usuario.nome, usuario.telefone, usuario.email, usuario.ativo)
            )
    ...
    def atualizar(self, usuario: Usuario) -> Usuario:
        ...
        try:
            cursor.execute(
                ...
                WHERE id = ?
                """,
                (usuario.nome, usuario.telefone, usuario.email, usuario.ativo, usuario.id)
            )
    ...
    def _converter_linha_para_usuario(linha: tuple) -> Usuario:
        ...
        """
        usuario_id, nome, telefone, email, ativo = linha
