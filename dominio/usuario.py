...
class Usuario:
    ...
    def _validar_telefone(telefone: Optional[str]) -> None:
        ...
        - Se fornecido, deve conter apenas números
        - Deve ter 10 ou 11 dígitos
        
        Args:
            telefone: Telefone a ser validado (ou None)
            
        Raises:
            UsuarioInvalidoError: Se telefone é inválido
        """
        if telefone is None:
            return  # Telefone é opcional, então None é válido
